    ...
    <div class="flex h-full flex-col px-3">
      <div class="py-6">
        <div class="flex items-center gap-3">
          ...
          <div class="min-w-0 app-shell__label-block"><p class="text-sm font-bold text-gray-500">مدیریت</p><h1 class="truncate text-xl font-black text-slate-900">حساب و رزرو</h1></div>
        </div>
      </div>
